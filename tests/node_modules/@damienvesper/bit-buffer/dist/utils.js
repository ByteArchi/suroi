...
const readString = (stream, length, index, utf8, bytes) => {
    if (bytes === 0)
        return ``;
    let i = 0;
    const chars = [];
...
const readASCIIString = (stream, length, index, bytes) => readString(stream, length, index, false, bytes);
exports.readASCIIString = readASCIIString;
const readUTF8String = (stream, length, index, bytes) => readString(stream, length, index, true, bytes);
exports.readUTF8String = readUTF8String;
const writeASCIIString = (stream, string, bytes) => {
...
const writeUTF8String = (stream, string, bytes) => {
